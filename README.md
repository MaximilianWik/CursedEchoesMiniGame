...
**Current version:** `0.2.10` — estus godmode is frame-perfect, grace veil pushes every word and projectile with a 5-ring cathedral burst. See [CHANGELOG.md](./CHANGELOG.md) for full history. Version is shown in-game on the menu, pause, settings, game-over and victory screens.
