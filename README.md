...
**Current version:** `0.3.4` — Dev Console password gate dropped; Jessyka dances on the AfroMan stage as a background prop. See [CHANGELOG.md](./CHANGELOG.md) for full history. Version is shown in-game on the menu, pause, settings, game-over and victory screens.
