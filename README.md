...
**Current version:** `0.3.5` — Game-over screen revamped with a three-column gothic stat plate, featured rank badge, and a prettier combo-over-time banner. See [CHANGELOG.md](./CHANGELOG.md) for full history. Version is shown in-game on the menu, pause, settings, game-over and victory screens.
